...
function v(a,b){a.prototype=ia(b.prototype);a.prototype.constructor=a;if(pa)pa(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.H=b.prototype}
...
b.prototype.then=function(g,h){function k(q,r){return"function"==typeof q?function(z){try{l(q(z))}catch(C){p(C)}}:r}
...
b.all=function(g){var h=u(g),k=h.next();return k.done?d([]):new b(function(l,p){function n(z){return function(C){q[z]=C;r--;0==r&&l(q)}}
...
function e(k){if(!Ba(k,g)){var l=new c;ca(k,g,{value:l})}}
...
E(Ua,Error);Ua.prototype.name="CustomError";function Wa(a){a=a.url;var b=/[?&]dsh=1(&|$)/.test(a);this.j=!b&&/[?&]ae=1(&|$)/.test(a);this.l=!b&&/[?&]ae=2(&|$)/.test(a);if((this.h=/[?&]adurl=([^&]*)/.exec(a))&&this.h[1]){try{var c=decodeURIComponent(this.h[1])}catch(d){c=null}this.i=c}}
...
var xb=/&/g,yb=/</g,zb=/>/g,Ab=/"/g,Bb=/'/g,Cb=/\x00/g,Db=/[\x00&<>"']/;function K(a,b){this.h=b===Eb?a:""}
m=K.prototype;m.W=!0;m.V=function(){return this.h.toString()};
m.ka=!0;m.ha=function(){return 1};
m.toString=function(){return this.h.toString()};
function Fb(a){if(a instanceof K&&a.constructor===K)return a.h;Ka(a);return"type_error:SafeUrl"}
var Gb=/^(?:audio\/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font\/\w+|image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|video\/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\w+=(?:\w+|"[\w;,= ]+"))*$/i,Hb=/^data:(.*);base64,[a-z0-9+\/]+=*$/i,Ib=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;function Jb(a){if(a instanceof K)return a;a="object"==typeof a&&a.W?a.V():String(a);Ib.test(a)||(a="about:invalid#zClosurez");return new K(a,Eb)}
var Eb={},Kb=new K("about:invalid#zClosurez",Eb);var Lb;a:{var Mb=x.navigator;if(Mb){var Nb=Mb.userAgent;if(Nb){Lb=Nb;break a}}Lb=""}function L(a){return-1!=Lb.indexOf(a)}
...
;function Rb(a,b){b=b instanceof K?b:Jb(b);a.href=Fb(b)}
...
;function cc(){return L("iPhone")&&!L("iPod")&&!L("iPad")}
;function dc(a){dc[" "](a);return a}
dc[" "]=Ia;var ec=L("Opera"),fc=L("Trident")||L("MSIE"),gc=L("Edge"),hc=L("Gecko")&&!(-1!=Lb.toLowerCase().indexOf("webkit")&&!L("Edge"))&&!(L("Trident")||L("MSIE"))&&!L("Edge"),ic=-1!=Lb.toLowerCase().indexOf("webkit")&&!L("Edge");function jc(){var a=x.document;return a?a.documentMode:void 0}
...
mc&&(lc=mc?mc[1]:"");if(fc){var nc=jc();if(null!=nc&&nc>parseFloat(lc)){kc=String(nc);break a}}kc=lc}var oc=kc,pc;if(x.document&&fc){var qc=jc();pc=qc?qc:parseInt(oc,10)||void 0}else pc=void 0;var rc=pc;var sc=cc()||L("iPod"),tc=L("iPad"),uc=L("Safari")&&!((L("Chrome")||L("CriOS"))&&!L("Edge")||L("Coast")||L("Opera")||L("Edge")||L("Edg/")||L("OPR")||L("Firefox")||L("FxiOS")||L("Silk")||L("Android"))&&!(cc()||L("iPad")||L("iPod"));var vc={},wc=null;
...
;var M=window;var yc=!fc||9<=Number(rc);function zc(a,b){this.x=void 0!==a?a:0;this.y=void 0!==b?b:0}
...
for(var e=2;e<c.length;e++){var f=c[e];if(!La(f)||B(f)&&0<f.nodeType)d(f);else{a:{if(f&&"number"==typeof f.length){if(B(f)){var g="function"==typeof f.item||"string"==typeof f.item;break a}if("function"===typeof f){g="function"==typeof f.item;break a}}g=!1}G(g?db(f):f,d)}}}
...
function b(n){for(var q=g,r=0;64>r;r+=4)q[r/4]=n[r]<<24|n[r+1]<<16|n[r+2]<<8|n[r+3];for(r=16;80>r;r++)n=q[r-3]^q[r-8]^q[r-14]^q[r-16],q[r]=(n<<1|n>>>31)&4294967295;n=e[0];var z=e[1],C=e[2],F=e[3],ma=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var N=F^z&(C^F);var I=1518500249}else N=z^C^F,I=1859775393;else 60>r?(N=z&C|F&(z|C),I=2400959708):(N=z^C^F,I=3395469782);N=((n<<5|n>>>27)&4294967295)+N+ma+I+q[r]&4294967295;ma=F;F=C;C=(z<<30|z>>>2)&4294967295;z=n;n=N}e[0]=e[0]+n&4294967295;e[1]=e[1]+z&4294967295;
e[2]=e[2]+C&4294967295;e[3]=e[3]+F&4294967295;e[4]=e[4]+ma&4294967295}
function c(n,q){if("string"===typeof n){n=unescape(encodeURIComponent(n));for(var r=[],z=0,C=n.length;z<C;++z)r.push(n.charCodeAt(z));n=r}q||(q=n.length);r=0;if(0==l)for(;r+64<q;)b(n.slice(r,r+64)),r+=64,p+=64;for(;r<q;)if(f[l++]=n[r++],p++,64==l)for(l=0,b(f);r+64<q;)b(n.slice(r,r+64)),r+=64,p+=64}
function d(){var n=[],q=8*p;56>l?c(h,56-l):c(h,64-(l-56));for(var r=63;56<=r;r--)f[r]=q&255,q>>>=8;b(f);for(r=q=0;5>r;r++)for(var z=24;0<=z;z-=8)n[q++]=e[r]>>z&255;return n}
...
;function Tc(a,b,c){var d=String(x.location.href);return d&&a&&b?[b,Uc(Rc(d),a,c||null)].join(" "):null}
...
m=Xc.prototype;m.isEnabled=function(){if(!x.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{ma:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
...
function $c(a,b,c,d){(a=x[a])||(a=(new Xc(document)).get(b));return a?Tc(a,c,d):null}
function ad(a){var b=void 0===b?!1:b;var c=Rc(String(x.location.href)),d=[];var e=b;e=void 0===e?!1:e;var f=x.__SAPISID||x.__APISID||x.__3PSAPISID||x.__OVERRIDE_SID;Zc(e)&&(f=f||x.__1PSAPISID);if(f)e=!0;else{var g=new Xc(document);f=g.get("SAPISID")||g.get("APISID")||g.get("__Secure-3PAPISID")||g.get("SID");Zc(e)&&(f=f||g.get("__Secure-1PAPISID"));e=!!f}e&&(e=(c=0==c.indexOf("https:")||0==c.indexOf("chrome-extension:")||0==c.indexOf("moz-extension:"))?x.__SAPISID:x.__APISID,e||(e=new Xc(document),
...
;var fd;
function gd(){var a=x.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!L("Presto")&&(a=function(){var e=Fc(document,"IFRAME");e.style.display="none";document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=D(function(k){if(("*"==h||k.origin==h)&&k.data==g)this.port1.onmessage()},this);
f.addEventListener("message",e,!1);this.port1={};this.port2={postMessage:function(){f.postMessage(g,h)}}});
if("undefined"!==typeof a&&!L("Trident")&&!L("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.ra;c.ra=null;e()}};
return function(e){d.next={ra:e};d=d.next;b.port2.postMessage(0)}}return function(e){x.setTimeout(e,0)}}
...
var md;function nd(){if(x.Promise&&x.Promise.resolve){var a=x.Promise.resolve(void 0);md=function(){a.then(qd)}}else md=function(){var b=qd;
"function"!==typeof x.setImmediate||x.Window&&x.Window.prototype&&!L("Edge")&&x.Window.prototype.setImmediate==x.setImmediate?(fd||(fd=gd()),fd(b)):x.setImmediate(b)}}
...
E(sd,rd);sd.prototype.reset=function(){this.h[0]=1732584193;this.h[1]=4023233417;this.h[2]=2562383102;this.h[3]=271733878;this.h[4]=3285377520;this.o=this.j=0};
...
sd.prototype.digest=function(){var a=[],b=8*this.o;56>this.j?this.update(this.l,56-this.j):this.update(this.l,this.i-(this.j-56));for(var c=this.i-1;56<=c;c--)this.m[c]=b&255,b/=256;td(this,this.m);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.h[c]>>d&255,++b;return a};function ud(a){var b=A("window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(g){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||x.$googDebugFname||b}catch(g){e="Not available",c=!0}b=vd(a);if(!(!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name)){c=a.message;if(null==
...
;function O(){this.h=this.h;this.o=this.o}
O.prototype.h=!1;O.prototype.dispose=function(){this.h||(this.h=!0,this.B())};
function Ad(a,b){a.h?b():(a.o||(a.o=[]),a.o.push(b))}
O.prototype.B=function(){if(this.o)for(;this.o.length;)this.o.shift()()};function Bd(a){return"string"==typeof a.className?a.className:a.getAttribute&&a.getAttribute("class")||""}
...
;var Fd="StopIteration"in x?x.StopIteration:{message:"StopIteration",stack:""};function Gd(){}
...
return e};var Od=function(){if(!x.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
try{x.addEventListener("test",Ia,b),x.removeEventListener("test",Ia,b)}catch(c){}return a}();function Pd(a,b){this.type=a;this.h=this.target=b;this.defaultPrevented=this.j=!1}
...
E(Qd,Pd);var Rd={2:"touch",3:"pen",4:"mouse"};
...
;var Zd="closure_lm_"+(1E6*Math.random()|0),$d={},ae=0;function be(a,b,c,d,e){if(d&&d.once)ce(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)be(a,b[f],c,d,e);else c=de(c),a&&a[Sd]?ee(a,b,c,B(d)?!!d.capture:!!d,e):fe(a,b,c,!1,d,e)}
function fe(a,b,c,d,e,f){if(!b)throw Error("Invalid event type");var g=B(e)?!!e.capture:!!e,h=ge(a);h||(a[Zd]=h=new Wd(a));c=h.add(b,c,d,g,f);if(!c.h){d=he();c.h=d;d.src=a;d.listener=c;if(a.addEventListener)Od||(e=g),void 0===e&&(e=!1),a.addEventListener(b.toString(),d,e);else if(a.attachEvent)a.attachEvent(ie(b.toString()),d);else if(a.addListener&&a.removeListener)a.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");ae++}}
function he(){function a(c){return b.call(a.src,a.listener,c)}
var b=je;return a}
function ce(a,b,c,d,e){if(Array.isArray(b))for(var f=0;f<b.length;f++)ce(a,b[f],c,d,e);else c=de(c),a&&a[Sd]?a.i.add(String(b),c,!0,B(d)?!!d.capture:!!d,e):fe(a,b,c,!0,d,e)}
function ke(a,b,c,d,e){if(Array.isArray(b))for(var f=0;f<b.length;f++)ke(a,b[f],c,d,e);else(d=B(d)?!!d.capture:!!d,c=de(c),a&&a[Sd])?a.i.remove(String(b),c,d,e):a&&(a=ge(a))&&(b=a.listeners[b.toString()],a=-1,b&&(a=Xd(b,c,d,e)),(c=-1<a?b[a]:null)&&le(c))}
...
return a[me]}
;function ne(){O.call(this);this.i=new Wd(this);this.F=this;this.u=null}
E(ne,O);ne.prototype[Sd]=!0;ne.prototype.addEventListener=function(a,b,c,d){be(this,a,b,c,d)};
...
;function P(a){this.h=0;this.u=void 0;this.l=this.i=this.j=null;this.o=this.m=!1;if(a!=Ia)try{var b=this;a.call(void 0,function(c){xe(b,2,c)},function(c){xe(b,3,c)})}catch(c){xe(this,3,c)}}
...
function Be(a){return new P(function(b,c){c(a)})}
P.prototype.then=function(a,b,c){return Ce(this,"function"===typeof a?a:null,"function"===typeof b?b:null,c)};
P.prototype.$goog_Thenable=!0;function De(a,b){return Ce(a,null,b,void 0)}
P.prototype.cancel=function(a){if(0==this.h){var b=new Ee(a);ld(function(){Fe(this,b)},this)}};
...
function Ce(a,b,c,d){var e=Ae(null,null,null);e.h=new P(function(f,g){e.i=b?function(h){try{var k=b.call(d,h);f(k)}catch(l){g(l)}}:f;
e.onRejected=c?function(h){try{var k=c.call(d,h);void 0===k&&h instanceof Ee?g(h):f(k)}catch(l){g(l)}}:g});
e.h.j=a;Ie(a,e);return e.h}
P.prototype.C=function(a){this.h=0;xe(this,2,a)};
P.prototype.F=function(a){this.h=0;xe(this,3,a)};
function xe(a,b,c){if(0==a.h){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.h=1;a:{var d=c,e=a.C,f=a.F;if(d instanceof P){Ie(d,Ae(e||Ia,f||null,a));var g=!0}else if(we(d))d.then(e,f,a),g=!0;else{if(B(d))try{var h=d.then;if("function"===typeof h){Ke(d,h,e,f,a);g=!0;break a}}catch(k){f.call(a,k);g=!0;break a}g=!1}}g||(a.u=c,a.h=b,a.j=null,Je(a),3!=b||c instanceof Ee||Le(a,c))}}
...
P.prototype.A=function(){for(var a;a=Ge(this);)He(this,a,this.h,this.u);this.m=!1};
...
var Ne=hd;function Ee(a){Ua.call(this,a)}
E(Ee,Ua);Ee.prototype.name="cancel";function Q(a){O.call(this);this.u=1;this.l=[];this.m=0;this.i=[];this.j={};this.A=!!a}
E(Q,O);m=Q.prototype;m.subscribe=function(a,b,c){var d=this.j[a];d||(d=this.j[a]=[]);var e=this.u;this.i[e]=a;this.i[e+1]=b;this.i[e+2]=c;this.u=e+3;d.push(e);return e};
...
m.B=function(){Q.H.B.call(this);this.clear();this.l.length=0};function Qe(a){this.h=a}
...
E(Re,Qe);function Se(a){this.data=a}
...
E(Ue,Re);Ue.prototype.set=function(a,b,c){if(b=Te(b)){if(c){if(c<Date.now()){Ue.prototype.remove.call(this,a);return}b.expiration=c}b.creation=Date.now()}Ue.H.set.call(this,a,b)};
...
;function We(){}
E(We,Ve);We.prototype.clear=function(){var a=Jd(this.L(!0)),b=this;G(a,function(c){b.remove(c)})};function Xe(a){this.h=a}
E(Xe,We);m=Xe.prototype;m.isAvailable=function(){if(!this.h)return!1;try{return this.h.setItem("__sak","1"),this.h.removeItem("__sak"),!0}catch(a){return!1}};
...
E(Ye,Xe);function Ze(a,b){this.i=a;this.h=null;if(fc&&!(9<=Number(rc))){$e||($e=new Kd);this.h=$e.get(a);this.h||(b?this.h=document.getElementById(b):(this.h=document.createElement("userdata"),this.h.addBehavior("#default#userData"),document.body.appendChild(this.h)),$e.set(a,this.h));try{this.h.load(this.i)}catch(c){this.h=null}}}
E(Ze,We);var af={".":".2E","!":".21","~":".7E","*":".2A","'":".27","(":".28",")":".29","%":"."},$e=null;function bf(a){return"_"+encodeURIComponent(a).replace(/[.!~*'()%]/g,function(b){return af[b]})}
...
E(df,We);df.prototype.set=function(a,b){this.i.set(this.h+a,b)};
...
;var ff=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};y("yt.config_",ff,void 0);function R(a){ef(ff,arguments)}
...
function kf(a){var b=A("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=H("ERRORS",[]),b.push([a,"ERROR",void 0,void 0,void 0]),R("ERRORS",b))}
function lf(a){var b=A("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0):(b=H("ERRORS",[]),b.push([a,"WARNING",void 0,void 0,void 0]),R("ERRORS",b))}
;var mf=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};y("yt.msgs_",mf,void 0);function nf(a){ef(mf,arguments)}
;function S(a){a=of(a);return"string"===typeof a&&"false"===a?!1:!!a}
...
;var qf=0;y("ytDomDomGetNextId",A("ytDomDomGetNextId")||function(){return++qf},void 0);var rf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
sf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var hb=x.ytEventsEventsListeners||{};y("ytEventsEventsListeners",hb,void 0);var uf=x.ytEventsEventsCounter||{count:0};y("ytEventsEventsCounter",uf,void 0);
...
;var zf=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function T(a,b){"function"===typeof a&&(a=jf(a));return window.setTimeout(a,b)}
function Af(a){window.clearTimeout(a)}
;function Bf(a){this.C=a;this.i=null;this.m=0;this.A=null;this.u=0;this.j=[];for(a=0;4>a;a++)this.j.push(0);this.l=0;this.I=xf(window,"mousemove",D(this.J,this));a=D(this.F,this);"function"===typeof a&&(a=jf(a));this.K=window.setInterval(a,25)}
E(Bf,O);Bf.prototype.J=function(a){void 0===a.h&&tf(a);var b=a.h;void 0===a.i&&tf(a);this.i=new zc(b,a.i)};
...
v(Gf,Cf);function Ef(a,b,c){void 0!==c&&Number.isNaN(Number(c))&&(c=void 0);var d=A("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):T(a,c||0)}
function Hf(a){if(void 0===a||!Number.isNaN(Number(a))){var b=A("yt.scheduler.instance.cancelJob");b?b(a):Af(a)}}
Gf.prototype.start=function(){var a=A("yt.scheduler.instance.start");a&&a()};
Gf.prototype.pause=function(){var a=A("yt.scheduler.instance.pause");a&&a()};
Ja(Gf);Gf.getInstance();var If={};
function Jf(a){var b=void 0===a?{}:a;a=void 0===b.Ha?!0:b.Ha;b=void 0===b.Ua?!1:b.Ua;if(null==A("_lact",window)){var c=parseInt(H("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&Kf();xf(document,"keydown",Kf);xf(document,"keyup",Kf);xf(document,"mousedown",Kf);xf(document,"mouseup",Kf);a&&(b?xf(window,"touchmove",function(){Lf("touchmove",200)},{passive:!0}):(xf(window,"resize",function(){Lf("resize",200)}),xf(window,"scroll",function(){Lf("scroll",200)})));
...
function Kf(){null==A("_lact",window)&&Jf();var a=Date.now();y("_lact",a,window);-1==A("_fact",window)&&y("_fact",a,window);(a=A("ytglobal.ytUtilActivityCallback_"))&&a()}
function Mf(){var a=A("_lact",window);return null==a?-1:Math.max(Date.now()-a,0)}
;function Nf(){var a=Of;A("yt.ads.biscotti.getId_")||y("yt.ads.biscotti.getId_",a,void 0)}
function Pf(a){y("yt.ads.biscotti.lastId_",a,void 0)}
...
;function Zf(a){var b=$f;a=void 0===a?A("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=Qc;e.flash="0";a:{try{var f=b.h.top.location.href}catch(J){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?M:g;try{var h=g.history.length}catch(J){h=0}e.u_his=h;e.u_java=!!M.navigator&&"unknown"!==typeof M.navigator.javaEnabled&&!!M.navigator.javaEnabled&&M.navigator.javaEnabled();M.screen&&(e.u_h=M.screen.height,e.u_w=M.screen.width,
e.u_ah=M.screen.availHeight,e.u_aw=M.screen.availWidth,e.u_cd=M.screen.colorDepth);M.navigator&&M.navigator.plugins&&(e.u_nplug=M.navigator.plugins.length);M.navigator&&M.navigator.mimeTypes&&(e.u_nmime=M.navigator.mimeTypes.length);h=b.h;try{var k=h.screenX;var l=h.screenY}catch(J){}try{var p=h.outerWidth;var n=h.outerHeight}catch(J){}try{var q=h.innerWidth;var r=h.innerHeight}catch(J){}try{var z=h.screenLeft;var C=h.screenTop}catch(J){}try{q=h.innerWidth,r=h.innerHeight}catch(J){}try{var F=h.screen.availWidth;
var ma=h.screen.availTop}catch(J){}k=[z,C,k,l,F,ma,p,n,q,r];l=b.h.top;try{var N=(l||window).document,I="CSS1Compat"==N.compatMode?N.documentElement:N.body;var aa=(new Ac(I.clientWidth,I.clientHeight)).round()}catch(J){aa=new Ac(-12245933,-12245933)}N=aa;aa={};I=new bd;x.SVGElement&&x.document.createElementNS&&I.set(0);l=Mc();l["allow-top-navigation-by-user-activation"]&&I.set(1);l["allow-popups-to-escape-sandbox"]&&I.set(2);x.crypto&&x.crypto.subtle&&I.set(3);x.TextDecoder&&x.TextEncoder&&I.set(4);
I=cd(I);aa.bc=I;aa.bih=N.height;aa.biw=N.width;aa.brdim=k.join();b=b.i;b=(aa.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[b.visibilityState||b.webkitVisibilityState||b.mozVisibilityState||""]||0,aa.wgl=!!M.WebGLRenderingContext,aa);c=d.call(c,e,b);c.ca_type="image";a&&(c.bid=a);return c}
var $f=new function(){var a=window.document;this.h=window;this.i=a};
y("yt.ads_.signals_.getAdSignalsString",function(a){return Vf(Zf(a))},void 0);var ag="XMLHttpRequest"in x?function(){return new XMLHttpRequest}:null;
...
return e}
function pg(a){if(B(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Qb(a[b],null);a[c]=d}else pg(a[b])}}
...
c=void 0===c?"GET":c;d=void 0===d?"":d;var k=bg();if(!k)return null;"onloadend"in k?k.addEventListener("loadend",h,!1):k.onreadystatechange=h;S("debug_forward_web_query_parameters")&&(a=hg(a));k.open(c,a,!0);f&&(k.responseType=f);g&&(k.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=gg(a,e))for(var l in e)k.setRequestHeader(l,e[l]),"content-type"==l.toLowerCase()&&(c=!1);c&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);
return k}
;var qg=sc||tc;function rg(a){var b=Lb;return b?0<=b.toLowerCase().indexOf(a):!1}
;var sg={},tg=0;
function ug(a,b,c,d,e){e=void 0===e?"":e;if(a)if(c&&!rg("cobalt")){if(a){a instanceof K||(a="object"==typeof a&&a.W?a.V():String(a),Ib.test(a)?a=new K(a,Eb):(a=String(a),a=a.replace(/(%0A|%0D)/g,""),a=(b=a.match(Hb))&&Gb.test(b[1])?new K(a,Eb):null));a=Fb(a||Kb);if("about:invalid#zClosurez"===a||a.startsWith("data"))a="";else{if(!(a instanceof Ob)){b="object"==typeof a;var f=null;b&&a.ka&&(f=a.ha());a=Qb(wb(b&&a.W?a.V():String(a)),f)}a instanceof Ob&&a.constructor===Ob?a=a.h:(Ka(a),a="type_error:SafeHtml");
...
c))&&c<l;){var p=a.charCodeAt(c-1);if(38==p||63==p){var n=a.charCodeAt(c+2);if(!n||61==n||38==n||35==n){var q=c;break d}}c+=3}q=-1}if(0>q)var r=null;else{var z=a.indexOf("&",q);if(0>z||z>l)z=l;q+=3;r=decodeURIComponent(a.substr(q,z-q).replace(/\+/g," "))}k="1"!==r}f=!k;break b}}catch(C){}f=!1}f?vg(a)?(b&&b(),f=!0):f=!1:f=!1;f||wg(a,b)}}
...
c.src=a}
;var yg=x.ytPubsubPubsubInstance||new Q,zg=x.ytPubsubPubsubSubscribedKeys||{},Ag=x.ytPubsubPubsubTopicToKeys||{},Bg=x.ytPubsubPubsubIsSynchronous||{};function Cg(a,b){var c=Dg();if(c&&b){var d=c.subscribe(a,function(){var e=arguments;var f=function(){zg[d]&&b.apply&&"function"==typeof b.apply&&b.apply(window,e)};
try{Bg[a]?f():T(f,0)}catch(g){kf(g)}},void 0);
...
function Dg(){return x.ytPubsubPubsubInstance}
function Hg(a){Ag[a]&&(a=Ag[a],G(a,function(b){zg[b]&&delete zg[b]}),a.length=0)}
Q.prototype.subscribe=Q.prototype.subscribe;Q.prototype.unsubscribeByKey=Q.prototype.X;Q.prototype.publish=Q.prototype.O;Q.prototype.clear=Q.prototype.clear;y("ytPubsubPubsubInstance",yg,void 0);y("ytPubsubPubsubTopicToKeys",Ag,void 0);y("ytPubsubPubsubIsSynchronous",Bg,void 0);y("ytPubsubPubsubSubscribedKeys",zg,void 0);var Ig=window,U=Ig.ytcsi&&Ig.ytcsi.now?Ig.ytcsi.now:Ig.performance&&Ig.performance.timing&&Ig.performance.now&&Ig.performance.timing.navigationStart?function(){return Ig.performance.timing.navigationStart+Ig.performance.now()}:function(){return(new Date).getTime()};var Jg=pf("initial_gel_batch_timeout",1E3),Kg=Math.pow(2,16)-1,Lg=null,Mg=0,Ng=void 0,Og=0,Pg=0,Qg=0,Rg=!0,Sg=x.ytLoggingTransportGELQueue_||new Map;y("ytLoggingTransportGELQueue_",Sg,void 0);var Tg=x.ytLoggingTransportTokensToCttTargetIds_||{};y("ytLoggingTransportTokensToCttTargetIds_",Tg,void 0);
function Ug(a,b){if("log_event"===a.endpoint){var c="";a.D&&(Tg[a.D.token]=Vg(a.D),c=a.D.token);var d=Sg.get(c)||[];Sg.set(c,d);d.push(a.payload);b&&(Ng=new b);a=pf("web_logging_max_batch")||100;b=U();d.length>=a?Wg({writeThenSend:!0}):10<=b-Qg&&(Xg(),Qg=b)}}
function Yg(a,b){if("log_event"===a.endpoint){var c="";a.D&&(Tg[a.D.token]=Vg(a.D),c=a.D.token);var d=new Map;d.set(c,[a.payload]);b&&(Ng=new b);return new P(function(e){Ng&&Ng.isReady()?Zg(d,e,{bypassNetworkless:!0}):e()})}}
function Wg(a){a=void 0===a?{}:a;new P(function(b){Af(Og);Af(Pg);Pg=0;Ng&&Ng.isReady()?(Zg(Sg,b,a),Sg.clear()):(Xg(),b())})}
function Xg(){S("web_gel_timeout_cap")&&!Pg&&(Pg=T(function(){Wg({writeThenSend:!0})},6E4));
Af(Og);var a=H("LOGGING_BATCH_TIMEOUT",pf("web_gel_debounce_ms",1E4));S("shorten_initial_gel_batch_timeout")&&Rg&&(a=Jg);Og=T(function(){Wg({writeThenSend:!0})},a)}
function Zg(a,b,c){var d=Ng;c=void 0===c?{}:c;var e=Math.round(U()),f=a.size;a=u(a);for(var g=a.next();!g.done;g=a.next()){var h=u(g.value);g=h.next().value;var k=h.next().value;h=nb({context:$g(d.h||ah())});h.events=k;(k=Tg[g])&&bh(h,g,k);delete Tg[g];ch(h,e);S("send_beacon_before_gel")&&window.navigator&&window.navigator.sendBeacon&&!c.writeThenSend&&xg("/generate_204");dh(d,"log_event",h,{retry:!0,onSuccess:function(){f--;f||b();Mg=Math.round(U()-e)},
onError:function(){f--;f||b()},
ya:c});Rg=!1}}
function ch(a,b){a.requestTimeMs=String(b);S("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);if(b=H("EVENT_ID",void 0)){var c=H("BATCH_CLIENT_COUNTER",void 0)||0;c||(c=Math.floor(Math.random()*Kg/2));c++;c>Kg&&(c=1);R("BATCH_CLIENT_COUNTER",c);b={serializedEventId:b,clientCounter:String(c)};a.serializedClientEventId=b;Lg&&Mg&&S("log_gel_rtt_web")&&(a.previousBatchInfo={serializedClientEventId:Lg,roundtripMs:String(Mg)});Lg=b;Mg=0}}
...
;var eh=x.ytLoggingGelSequenceIdObj_||{};y("ytLoggingGelSequenceIdObj_",eh,void 0);function fh(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;a=Mf();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};S("log_sequence_info_on_gel_web")&&d.M&&(a=e.context,b=d.M,eh[b]=b in eh?eh[b]+1:0,a.sequence={index:eh[b],groupKey:b},d.Fa&&delete eh[d.M]);(d.Fk?Yg:Ug)({endpoint:"log_event",payload:e,D:d.D},c)}
;function gh(){if(!x.matchMedia)return"WEB_DISPLAY_MODE_UNKNOWN";try{return x.matchMedia("(display-mode: standalone)").matches?"WEB_DISPLAY_MODE_STANDALONE":x.matchMedia("(display-mode: minimal-ui)").matches?"WEB_DISPLAY_MODE_MINIMAL_UI":x.matchMedia("(display-mode: fullscreen)").matches?"WEB_DISPLAY_MODE_FULLSCREEN":x.matchMedia("(display-mode: browser)").matches?"WEB_DISPLAY_MODE_BROWSER":"WEB_DISPLAY_MODE_UNKNOWN"}catch(a){return"WEB_DISPLAY_MODE_UNKNOWN"}}
;function hh(a,b,c,d,e){Yc.set(""+a,b,{ma:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
;var V=A("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",V,void 0);function ih(){this.h=H("ALT_PREF_COOKIE_NAME","PREF");this.i=H("ALT_PREF_COOKIE_DOMAIN","youtube.com");var a=Yc.get(""+this.h,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(V[d]=c.toString())}}}
ih.prototype.get=function(a,b){jh(a);kh(a);a=void 0!==V[a]?V[a].toString():null;return null!=a?a:b?b:""};
ih.prototype.set=function(a,b){jh(a);kh(a);if(null==b)throw Error("ExpectedNotNull");V[a]=b.toString()};
ih.prototype.remove=function(a){jh(a);kh(a);delete V[a]};
ih.prototype.clear=function(){for(var a in V)delete V[a]};
...
function lh(a){a=void 0!==V[a]?V[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
...
function oh(){var a=x.navigator;return a?a.connection:void 0}
...
function $g(a){var b={client:{hl:a.La,gl:a.Ka,clientName:a.Ja,clientVersion:a.innertubeContextClientVersion,configInfo:a.Ia}},c=x.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=H("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=H("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=H("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
f=b.client.clientName;if("WEB"===f||"MWEB"===f||1===f||2===f){if(!S("web_include_display_mode_killswitch")){var g;b.client.mainAppWebInfo=null!=(g=b.client.mainAppWebInfo)?g:{};b.client.mainAppWebInfo.webDisplayMode=gh()}}else if(g=b.client.clientName,("WEB_REMIX"===g||76===g)&&!S("music_web_display_mode_killswitch")){var h;b.client.xa=null!=(h=b.client.xa)?h:{};b.client.xa.webDisplayMode=gh()}a.appInstallData&&(b.client.configInfo=b.client.configInfo||{},b.client.configInfo.appInstallData=a.appInstallData);
H("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(b.user={onBehalfOfUser:H("DELEGATED_SESSION_ID")});a:{if(h=oh()){a=mh[h.type||"unknown"]||"CONN_UNKNOWN";h=mh[h.effectiveType||"unknown"]||"CONN_UNKNOWN";"CONN_CELLULAR_UNKNOWN"===a&&"CONN_UNKNOWN"!==h&&(a=h);if("CONN_UNKNOWN"!==a)break a;if("CONN_UNKNOWN"!==h){a=h;break a}}a=void 0}a&&(b.client.connectionType=a);S("web_log_effective_connection_type")&&(a=oh(),a=null!==a&&void 0!==a&&a.effectiveType?nh.hasOwnProperty(a.effectiveType)?nh[a.effectiveType]:
...
function qh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||H("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.vk||H("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().uk:b=ad([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=H("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=H("DELEGATED_SESSION_ID")));return d}
...
function vh(a,b,c,d){if(d)return null;d=uh().get("nextId",!0)||1;var e=uh().get("requests",!0)||{};e[d]={method:a,request:b,authState:rh(c),requestTime:Math.round(U())};uh().set("nextId",d+1,86400,!0);uh().set("requests",e,86400,!0);return d}
function wh(a){var b=uh().get("requests",!0)||{};delete b[a];uh().set("requests",b,86400,!0)}
function xh(a){var b=uh().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=rh(qh(!1));lb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),dh(a,d.method,e,{}));delete b[c]}}uh().set("requests",b,86400,!0)}}
;function yh(a,b){this.version=a;this.args=b}
;function zh(a,b){this.topic=a;this.h=b}
zh.prototype.toString=function(){return this.topic};var Ah=A("ytPubsub2Pubsub2Instance")||new Q;Q.prototype.subscribe=Q.prototype.subscribe;Q.prototype.unsubscribeByKey=Q.prototype.X;Q.prototype.publish=Q.prototype.O;Q.prototype.clear=Q.prototype.clear;y("ytPubsub2Pubsub2Instance",Ah,void 0);var Bh=A("ytPubsub2Pubsub2SubscribedKeys")||{};y("ytPubsub2Pubsub2SubscribedKeys",Bh,void 0);var Ch=A("ytPubsub2Pubsub2TopicToKeys")||{};y("ytPubsub2Pubsub2TopicToKeys",Ch,void 0);var Dh=A("ytPubsub2Pubsub2IsAsync")||{};y("ytPubsub2Pubsub2IsAsync",Dh,void 0);
y("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Eh(a,b){var c=Fh();c&&c.publish.call(c,a.toString(),a,b)}
function Gh(a){var b=Hh,c=Fh();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=A("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(Bh[d])try{if(f&&b instanceof zh&&b!=e)try{var h=b.h,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.N){var l=new h;h.N=l.version}var p=h.N}catch(n){}if(!p||k.version!=p)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
db(k.args))}catch(n){throw n.message="yt.pubsub2.Data.deserialize(): "+n.message,n;}}catch(n){throw n.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+n.message,n;}a.call(window,f)}catch(n){kf(n)}},Dh[b.toString()]?A("yt.scheduler.instance")?Df(g):T(g,0):g())});
...
function Fh(){return A("ytPubsub2Pubsub2Instance")}
...
function Ph(a,b,c){var d;this.i=void 0===a?!1:a;this.failureMessage=b;this.j=c;this.h=null===(d=Oh())||void 0===d?void 0:d.get("LAST_RESULT_ENTRY_KEY",!0);this.h||(this.h={createdTimestampMs:U(),isSupported:this.i,resultCount:0});var e;if(Qh()){var f;this.h.isSupported===this.i?f=Object.assign(Object.assign({},this.h),{resultCount:this.h.resultCount+1}):f={isSupported:this.i,resultCount:1,createdTimestampMs:U()};null===(e=Oh())||void 0===e?void 0:e.set("LAST_RESULT_ENTRY_KEY",f,2592E3,!0)}}
function Rh(a,b){return new Ph(!1,a instanceof Error?a.message:"",void 0===b?!1:b)}
Ph.prototype.isSupported=function(){return this.i};
Ph.prototype.log=function(){Qh()&&Nh("IS_SUPPORTED_COMPLETED",{isSupported:this.i,lastIsSupported:this.h.isSupported,failureMessage:this.failureMessage,sameResultCount:this.h.resultCount,sameResultDurationMs:Math.floor(U()-this.h.createdTimestampMs),canDetectDataOnFailure:this.j})};
function Qh(){var a;return!!(S("ytidb_analyze_is_supported")&&(null===(a=Oh())||void 0===a?0:a.h))}
;function W(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:ha(u(c)))}
v(W,Error);function Sh(a){return a.substr(0,a.indexOf(":"))||a}
...
Xh.UNKNOWN_ABORT=!0,Xh);function X(a,b,c,d,e){b=void 0===b?{}:b;c=void 0===c?Uh[a]:c;d=void 0===d?Wh[a]:d;e=void 0===e?Yh[a]:e;W.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;this.level=d;this.h=e;Object.setPrototypeOf(this,X.prototype)}
v(X,W);function Zh(a){X.call(this,"MISSING_OBJECT_STORE",{Ak:a},Uh.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Zh.prototype)}
v(Zh,X);var $h=["The database connection is closing","Can't start a transaction on a closed database","A mutation operation was attempted on a database that did not allow mutations"];
function ai(a,b,c){b=Sh(b);var d=a instanceof Error?a:Error("Unexpected error: "+a);if(d instanceof X)return d;if("QuotaExceededError"===d.name)return new X("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:b});if(uc&&"UnknownError"===d.name)return new X("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:b});if("InvalidStateError"===d.name&&$h.some(function(e){return d.message.includes(e)}))return new X("EXECUTE_TRANSACTION_ON_CLOSED_DB",{objectStoreNames:c,
dbName:b});if("AbortError"===d.name)return new X("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},d.message);d.args=[{name:"IdbError",Bk:d.name,dbName:b,objectStoreNames:c}];d.level="WARNING";return d}
...
Y.all=function(a){return new Y(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={R:0};f.R<a.length;f={R:f.R},++f.R)di(Y.resolve(a[f.R]).then(function(g){return function(h){d[g.R]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})})};
...
Y.prototype.then=function(a,b){var c=this,d=null!==a&&void 0!==a?a:ci,e=null!==b&&void 0!==b?b:bi;return new Y(function(f,g){"PENDING"===c.state.status?(c.h.push(function(){ei(c,c,d,f,g)}),c.onRejected.push(function(){fi(c,c,e,f,g)})):"FULFILLED"===c.state.status?ei(c,c,d,f,g):"REJECTED"===c.state.status&&fi(c,c,e,f,g)})};
function di(a,b){a.then(void 0,b)}
function ei(a,b,c,d,e){try{if("FULFILLED"!==a.state.status)throw Error("calling handleResolve before the promise is fulfilled.");var f=c(a.state.value);f instanceof Y?gi(a,b,f,d,e):d(f)}catch(g){e(g)}}
function fi(a,b,c,d,e){try{if("REJECTED"!==a.state.status)throw Error("calling handleReject before the promise is rejected.");var f=c(a.state.reason);f instanceof Y?gi(a,b,f,d,e):d(f)}catch(g){e(g)}}
function gi(a,b,c,d,e){b===c?e(new TypeError("Circular promise chain detected.")):c.then(function(f){f instanceof Y?gi(a,b,f,d,e):d(f)},function(f){e(f)})}
...
function ji(a){return new Y(function(b,c){hi(a,b,c)})}
;function ki(a,b){return new Y(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
e()})}
;function li(a){return new Promise(function(b){Ff(function(){b()},a)})}
function mi(a,b){this.h=a;this.options=b;this.transactionCount=0;this.j=Math.round(U());this.i=!1}
m=mi.prototype;m.add=function(a,b,c){return ni(this,[a],{mode:"readwrite",U:S("ytidb_transaction_enable_retries_core_and_nwl")},function(d){return oi(d,a).add(b,c)})};
m.clear=function(a){return ni(this,[a],{mode:"readwrite",U:S("ytidb_transaction_enable_retries_core_and_nwl")},function(b){return oi(b,a).clear()})};
m.close=function(){var a;this.h.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
m.count=function(a,b){return ni(this,[a],{mode:"readonly",U:S("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return oi(c,a).count(b)})};
m.delete=function(a,b){return ni(this,[a],{mode:"readwrite",U:S("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return oi(c,a).delete(b)})};
m.get=function(a,b){return ni(this,[a],{mode:"readonly",U:S("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return oi(c,a).get(b)})};
function ni(a,b,c,d){return bc(a,function f(){var g=this,h,k,l,p,n,q,r,z,C,F,ma,N,I,aa;return za(f,function(J){switch(J.h){case 1:var Va={mode:"readonly",U:!1};"string"===typeof c?Va.mode=c:Va=c;h=Va;g.transactionCount++;k=S("ytidb_transaction_exponential_backoff_retries");l=h.U?pf("ytidb_transaction_try_count",1):1;p=500;n=0;case 2:if(q){J.h=3;break}n++;r=Math.round(U());J.j=4;z=g.h.transaction(b,h.mode);Va=new pi(z);Va=qi(Va,d);return w(J,Va,6);case 6:return C=J.i,F=Math.round(U()),ri(g,r,F,n,void 0,
b.join(),h),J.return(C);case 4:ma=ta(J);N=Math.round(U());I=ai(ma,g.h.name,b.join());if((aa=I instanceof X&&!I.h)||n>=l){ri(g,r,N,n,I,b.join(),h);q=I;J.h=2;break}if(!k){J.h=2;break}return w(J,li(p),9);case 9:p*=2;J.h=2;break;case 3:return J.return(Promise.reject(q))}})})}
function ri(a,b,c,d,e,f,g){b=c-b;e?(e instanceof X&&("QUOTA_EXCEEDED"===e.type||"QUOTA_MAYBE_EXCEEDED"===e.type)&&Nh("QUOTA_EXCEEDED",{dbName:Sh(a.h.name),objectStoreNames:f,transactionCount:a.transactionCount,transactionMode:g.mode}),e instanceof X&&"UNKNOWN_ABORT"===e.type&&(Nh("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:f,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c-a.j}),a.i=!0),si(a,!1,d,f,b),Mh||(Lh.push({type:"ERROR",payload:e}),10<Lh.length&&Lh.shift())):
si(a,!0,d,f,b)}
function si(a,b,c,d,e){Nh("TRANSACTION_ENDED",{objectStoreNames:d,connectionHasUnknownAbortedTransaction:a.i,duration:e,isSuccessful:b,tryCount:c})}
function ti(a){this.h=a}
m=ti.prototype;m.add=function(a,b){return ji(this.h.add(a,b))};
...
m.delete=function(a){return a instanceof IDBKeyRange?ui(this,a):ji(this.h.delete(a))};
m.get=function(a){return ji(this.h.get(a))};
m.index=function(a){return new wi(this.h.index(a))};
m.getName=function(){return this.h.name};
function vi(a,b,c){a=a.h.openCursor(b.query,b.direction);return xi(a).then(function(d){return ki(d,c)})}
function pi(a){var b=this;this.h=a;this.i=new Map;this.aborted=!1;this.done=new Promise(function(c,d){b.h.addEventListener("complete",function(){c()});
...
function qi(a,b){var c=new Promise(function(d,e){di(b(a).then(function(f){a.commit();d(f)}),e)});
return Promise.all([c,a.done]).then(function(d){return u(d).next().value})}
pi.prototype.abort=function(){this.h.abort();this.aborted=!0;throw new X("EXPLICIT_ABORT");};
pi.prototype.commit=function(){var a=this.h;a.commit&&!this.aborted&&a.commit()};
function oi(a,b){b=a.h.objectStore(b);var c=a.i.get(b);c||(c=new ti(b),a.i.set(b,c));return c}
function wi(a){this.h=a}
wi.prototype.count=function(a){return ji(this.h.count(a))};
wi.prototype.delete=function(a){return yi(this,{query:a},function(b){return b.delete().then(function(){return b.continue()})})};
wi.prototype.get=function(a){return ji(this.h.get(a))};
wi.prototype.getKey=function(a){return ji(this.h.getKey(a))};
function yi(a,b,c){a=a.h.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return xi(a).then(function(d){return ki(d,c)})}
function zi(a,b){this.request=a;this.cursor=b}
function xi(a){return ji(a).then(function(b){return null===b?null:new zi(a,b)})}
...
m.update=function(a){return ji(this.cursor.update(a))};function Ai(a,b,c){return bc(this,function e(){var f,g,h,k,l,p,n,q,r,z;return za(e,function(C){if(1==C.h)return f=self.indexedDB.open(a,b),g=c,h=g.blocked,k=g.blocking,l=g.fb,p=g.upgrade,n=g.closed,r=function(){q||(q=new mi(f.result,{closed:n}));return q},f.addEventListener("upgradeneeded",function(F){if(null===F.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");
if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");F.dataLoss&&"none"!==F.dataLoss&&Nh("IDB_DATA_CORRUPTED",{reason:F.dataLossMessage||"unknown reason",dbName:Sh(a)});var ma=r(),N=new pi(f.transaction);p&&p(ma,F.oldVersion,F.newVersion,N)}),h&&f.addEventListener("blocked",function(){h()}),w(C,ii(f),2);
z=C.i;k&&z.addEventListener("versionchange",function(){k(r())});
z.addEventListener("close",function(){Nh("IDB_UNEXPECTEDLY_CLOSED",{dbName:Sh(a),dbVersion:z.version});l&&l()});
return C.return(r())})})}
function Bi(a,b){b=void 0===b?{}:b;return bc(this,function d(){var e,f,g;return za(d,function(h){e=self.indexedDB.deleteDatabase(a);f=b;(g=f.blocked)&&e.addEventListener("blocked",function(){g()});
return w(h,ii(e),0)})})}
...
Ci.prototype.open=function(){var a=this;if(!this.h){var b,c=function(){a.h===b&&(a.h=void 0)},d={blocking:function(f){f.close()},
closed:c,fb:c,upgrade:this.options.upgrade},e=function(){return bc(a,function g(){var h=this,k,l,p;return za(g,function(n){switch(n.h){case 1:return n.j=2,w(n,Di(h.name,h.options.version,d),4);case 4:k=n.i;a:{var q=u(Object.keys(h.options.Ra));for(var r=q.next();!r.done;r=q.next())if(r=r.value,!k.h.objectStoreNames.contains(r)){q=r;break a}q=void 0}l=q;if(void 0===l){n.h=5;break}if(h.i){n.h=6;break}h.i=!0;return w(n,h.delete(),7);case 7:return n.return(e());case 6:throw new Zh(l);case 5:return n.return(k);
case 2:p=ta(n);if(p instanceof DOMException?"VersionError"===p.name:"DOMError"in self&&p instanceof DOMError?"VersionError"===p.name:p instanceof Object&&"message"in p&&"An attempt was made to open a database using a lower version than the existing version."===p.message)return n.return(Di(h.name,void 0,Object.assign(Object.assign({},d),{upgrade:void 0})));c();throw p;}})})};
this.h=b=e()}return this.h};var Ei=new Ci({Ra:{databases:!0},upgrade:function(a,b){1>b&&a.h.createObjectStore("databases",{keyPath:"actualName"})}});
function Fi(a){return bc(this,function c(){var d;return za(c,function(e){if(1==e.h)return w(e,Ei.open(),2);d=e.i;return e.return(ni(d,["databases"],"readwrite",function(f){var g=oi(f,"databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier||a.clearDataOnAuthChange!==h.clearDataOnAuthChange:1)return ji(g.h.put(a,void 0)).then(function(){})})}))})})}
function Gi(){return bc(this,function b(){var c;return za(b,function(d){if(1==d.h)return w(d,Ei.open(),2);c=d.i;return d.return(c.delete("databases","yt-idb-test-do-not-use"))})})}
function Hi(){return bc(this,function b(){var c,d;return za(b,function(e){if(1==e.h)return w(e,Ei.open(),2);if(3!=e.h)return c=e.i,w(e,c.count("databases"),3);d=e.i;return e.return(0<d)})})}
;var Ii;
...
"objectStoreNames"in IDBTransaction.prototype))return g.return(Rh(Error("IDBTransaction.prototype.objectStoreNames is missing")));g.j=2;d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return w(g,Fi(d),4);case 4:return w(g,Gi(),5);case 5:return g.return(new Ph(!0));case 2:e=ta(g);if(!Qh()){g.h=6;break}g.j=7;return w(g,Hi(),9);case 9:return f=g.i,g.return(Rh(e,f));case 7:return ta(g),g.return(Rh(e));case 6:return g.return(Rh(e))}})})}
function Ki(){if(void 0!==Ii)return Ii;Mh=!0;return Ii=Ji().then(function(a){Mh=!1;a.log();return a.isSupported()})}
;var Li;function Mi(){Li||(Li=new sh("yt.offline"));return Li}
;function Ni(){ne.call(this);this.l=this.A=this.C=this.m=!1;this.j=Oi();this.l=S("validate_network_status");Pi(this);Qi(this)}
v(Ni,ne);function Oi(){var a=window.navigator.onLine;return void 0===a?!0:a}
function Qi(a){window.addEventListener("online",function(){return bc(a,function c(){var d=this;return za(c,function(e){if(1==e.h){if(!d.l){d.j=!0;e.h=2;return}return w(e,Ri(d),3)}2!=e.h&&(d.j=e.i);d.m&&d.j&&oe(d,"ytnetworkstatus-online");Si(d);if(d.A&&S("offline_error_handling")){var f=Mi().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new W(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;kf(h)}Mi().set("errors",{},2592E3,!0)}}e.h=0})})})}
function Pi(a){window.addEventListener("offline",function(){return bc(a,function c(){var d=this;return za(c,function(e){if(1==e.h){if(!d.l){d.j=!1;e.h=2;return}return w(e,Ri(d),3)}2!=e.h&&(d.j=e.i);d.m&&!d.j&&oe(d,"ytnetworkstatus-offline");Si(d);e.h=0})})})}
function Si(a){a.C&&(lf(new W("NetworkStatusManager state did not match poll",U()-0)),a.C=!1)}
function Ri(a){return bc(a,function c(){var d;return za(c,function(e){switch(e.h){case 1:return e.j=2,w(e,fetch("/generate_204",{method:"HEAD"}),4);case 4:d=!0;e.h=3;e.j=0;break;case 2:ta(e),d=!1;case 3:return e.return(d)}})})}
;function Ti(a){a=void 0===a?{}:a;ne.call(this);var b=this;this.l=this.A=0;Ni.h||(Ni.h=new Ni);this.j=Ni.h;this.j.m=!0;a.Qa&&(this.j.A=!0);a.ea?(this.ea=a.ea,ee(this.j,"ytnetworkstatus-online",function(){Ui(b,"publicytnetworkstatus-online")}),ee(this.j,"ytnetworkstatus-offline",function(){Ui(b,"publicytnetworkstatus-offline")})):(ee(this.j,"ytnetworkstatus-online",function(){oe(b,"publicytnetworkstatus-online")}),ee(this.j,"ytnetworkstatus-offline",function(){oe(b,"publicytnetworkstatus-offline")}))}
v(Ti,ne);function Vi(){Wi||(Wi=new Ti({Qa:!0}));var a=Wi.j;a.l||a.j===Oi()||lf(new W("NetworkStatusManager isOnline does not match window status"))}
function Ui(a,b){a.ea?a.l?(Hf(a.A),a.A=Df(function(){a.m!==b&&(oe(a,b),a.m=b,a.l=U())},a.ea-(U()-a.l))):(oe(a,b),a.m=b,a.l=U()):oe(a,b)}
;var Wi;function Xi(a,b){b=void 0===b?{}:b;S("skip_is_supported_killswitch")?Ki().then(function(){Vi();ig(a,b)}):(Vi(),ig(a,b))}
function Yi(a,b){b=void 0===b?{}:b;S("skip_is_supported_killswitch")?Ki().then(function(){ig(a,b)}):ig(a,b)}
;function Zi(a){var b=this;this.h=null;a?this.h=a:ph()&&(this.h=ah());Ef(function(){xh(b)},0,5E3)}
Zi.prototype.isReady=function(){!this.h&&ph()&&(this.h=ah());return!!this.h};
function dh(a,b,c,d){!H("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&lf(new W("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var e=new W("innertube xhrclient not ready",b,c,d);kf(e);throw e;}var f={headers:{"Content-Type":"application/json"},method:"POST",postParams:c,postBodyFormat:"JSON",onTimeout:function(){d.onTimeout()},
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.h.Ma)&&(g=e);var h=a.h.Oa||!1,k=qh(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.h.innertubeApiVersion+"/"+b;var l={alt:"json"};a.h.Na&&f.headers.Authorization||(l.key=a.h.innertubeApiKey);var p=Xf(""+g+e,l||{},!0);(function(n){n=void 0===n?!1:n;var q;if(d.retry&&"www.youtube-nocookie.com"!=g&&(n||(q=vh(b,c,k,h)),q)){var r=f.onSuccess,z=f.onFetchSuccess;f.onSuccess=function(C,
F){wh(q);r(C,F)};
c.onFetchSuccess=function(C,F){wh(q);z(C,F)}}try{n&&d.retry&&!d.ya.bypassNetworkless?(f.method="POST",!d.ya.writeThenSend&&S("nwl_send_fast_on_unload")?Yi(p,f):Xi(p,f)):(f.method="POST",f.postParams||(f.postParams={}),ig(p,f))}catch(C){if("InvalidAccessError"==C.name)q&&(wh(q),q=0),lf(Error("An extension is blocking network request."));
else throw C;}q&&Ef(function(){xh(a)},0,5E3)})(!1)}
;function $i(a,b,c){c=void 0===c?{}:c;var d=Zi;H("ytLoggingEventsDefaultDisabled",!1)&&Zi==Zi&&(d=null);fh(a,b,d,c)}
;var aj=[{wa:function(a){return"Cannot read property '"+a.key+"'"},
...
groups:["key"]},{regexp:/\uac1c\uccb4\uac00 '([^']+)' \uc18d\uc131\uc774\ub098 \uba54\uc11c\ub4dc\ub97c \uc9c0\uc6d0\ud558\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4./,groups:["key"]}]}}];function bj(){this.h=[];this.i=[]}
var cj;function dj(){cj||(cj=new bj);return cj}
;var ej=new Q;function fj(a){function b(){return a.charCodeAt(d++)}
var c=a.length,d=0;do{var e=gj(b);if(Infinity===e)break;var f=e>>3;switch(e&7){case 0:e=gj(b);if(2===f)return e;break;case 1:if(2===f)return;d+=8;break;case 2:e=gj(b);if(2===f)return a.substr(d,e);d+=e;break;case 5:if(2===f)return;d+=4;break;default:return}}while(d<c)}
function gj(a){var b=a(),c=b&127;if(128>b)return c;b=a();c|=(b&127)<<7;if(128>b)return c;b=a();c|=(b&127)<<14;if(128>b)return c;b=a();return 128>b?c|(b&127)<<21:Infinity}
;function hj(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=ij(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=e;var g=a[e],h=b,k=c;f="string"!==typeof g||"clickTrackingParams"!==f&&"trackingParams"!==f?0:(g=fj(atob(g.replace(/-/g,"+").replace(/_/g,"/"))))?ij(f+".ve",g,h,k):0;d+=f;d+=ij(e,a[e],b,c);if(500<d)break}}else c[b]=jj(a),d+=c[b].length;else c[b]=jj(a),d+=c[b].length;return d}
function ij(a,b,c,d){c+="."+a;a=jj(b);d[c]=a;return c.length+a.length}
function jj(a){return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}
;var kj=new Set,lj=0,mj=0,nj=0,oj=[],pj=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function qj(a){rj(a,"WARNING")}
function rj(a,b,c,d,e,f){f=void 0===f?{}:f;f.name=c||H("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||H("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);c=f||{};b=void 0===b?"ERROR":b;b=void 0===b?"ERROR":b;if(a&&(a.level&&(b=a.level),S("console_log_js_exceptions")&&(d=[],d.push("Name: "+a.name),d.push("Message: "+a.message),a.hasOwnProperty("params")&&d.push("Error Params: "+JSON.stringify(a.params)),a.hasOwnProperty("args")&&d.push("Error args: "+JSON.stringify(a.args)),d.push("File name: "+a.fileName),
d.push("Stacktrace: "+a.stack),window.console.log(d.join("\n"),a)),!(5<=lj))){var g=ud(a);d=g.message||"Unknown Error";e=g.name||"UnknownError";var h=g.stack||a.i||"Not available";h.startsWith(e+": "+d)&&(f=h.split("\n"),f.shift(),h=f.join("\n"));f=g.lineNumber||"Not available";g=g.fileName||"Not available";var k=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var l=0;l<a.args.length&&!(k=hj(a.args[l],"params."+l,c,k),500<=k);l++);else if(a.hasOwnProperty("params")&&a.params){var p=a.params;
if("object"===typeof a.params)for(l in p){if(p[l]){var n="params."+l,q=jj(p[l]);c[n]=q;k+=n.length+q.length;if(500<k)break}}else c.params=jj(p)}if(oj.length)for(l=0;l<oj.length&&!(k=hj(oj[l],"params.context."+l,c,k),500<=k);l++);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c["device.vendor"]=navigator.vendor);l={message:d,name:e,lineNumber:f,fileName:g,stack:h,params:c,sampleWeight:1};c=Number(a.columnNumber);isNaN(c)||(l.lineNumber=l.lineNumber+":"+c);if("IGNORED"===a.level)a=0;else a:{a=dj();
c=u(a.i);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.zk)){a=d.weight;break a}a=u(a.h);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Da(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(aj);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.na[l.name])for(e=u(c.na[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=d[g+
1];l.message=c.wa(f);break}l.params||(l.params={});a=dj();l.params["params.errorServiceSignature"]="msg="+a.i.length+"&cb="+a.h.length;l.params["params.serviceWorker"]="false";x.document&&x.document.querySelectorAll&&(l.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));window.yterr&&"function"===typeof window.yterr&&window.yterr(l);if(0!==l.sampleWeight&&!kj.has(l.message)){"ERROR"===b?(ej.O("handleError",l),S("record_app_crashed_web")&&0===nj&&1===l.sampleWeight&&
(nj++,$i("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),mj++):"WARNING"===b&&ej.O("handleWarning",l);if(S("kevlar_gel_error_routing")){a=b;b:{c=u(pj);for(d=c.next();!d.done;d=c.next())if(rg(d.value.toLowerCase())){c=!0;break b}c=!1}if(c)c=void 0;else{d={stackTrace:l.stack};l.fileName&&(d.filename=l.fileName);c=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==c.length&&(1!==c.length||isNaN(Number(c[0]))?2!==c.length||isNaN(Number(c[0]))||isNaN(Number(c[1]))||(d.lineNumber=Number(c[0]),
...
f=H("SERVER_NAME",void 0);g=H("SERVER_VERSION",void 0);f&&g&&(e.kvPairs.push({key:"server.name",value:f}),e.kvPairs.push({key:"server.version",value:g}));c={errorMetadata:e,stackTrace:d,logMessage:c}}c&&($i("clientError",c),("ERROR"===a||S("errors_flush_gel_always_killswitch"))&&Wg())}if(!S("suppress_error_204_logging")){a=l.params||{};b={urlParams:{a:"logerror",t:"jserror",type:l.name,msg:l.message.substr(0,250),line:l.lineNumber,level:b,"client.name":a.name},postParams:{url:H("PAGE_NAME",window.location.href),
...
"")+"/error_204",b)}kj.add(l.message);lj++}}}
...
function Aj(a,b,c){c=void 0===c?null:c;var d=Bj(a),e=document.getElementById(d),f=e&&vj(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Cg(d,b),b=""+Ma(b),Cj[b]=f),g||(e=Dj(a,d,function(){vj(e,"loaded")||(tj(e),Fg(d),T(Ra(Gg,d),0))},c)))}
function Dj(a,b,c,d){d=void 0===d?null:d;var e=Fc(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Ej(a){a=Bj(a);var b=document.getElementById(a);b&&(Gg(a),b.parentNode.removeChild(b))}
function Fj(a,b){a&&b&&(a=""+Ma(b),(a=Cj[a])&&Eg(a))}
function Bj(a){var b=document.createElement("a");Rb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Ub(a)}
var Cj={};var Gj=[],Hj=!1;function Ij(){if(!S("disable_ad_status_on_html5_clients")&&(!S("condition_ad_status_fetch_on_consent_cookie_html5_clients")||Yc.get("CONSENT","").startsWith("YES+"))&&"1"!=kb()){var a=function(){Hj=!0;"google_ad_status"in window?R("DCLKSTAT",1):R("DCLKSTAT",2)};
try{zj("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Gj.push(Df(function(){if(!(Hj||"google_ad_status"in window)){try{Fj("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Hj=!0;R("DCLKSTAT",3)}},5E3))}}
function Jj(){var a=Number(H("DCLKSTAT",0));return isNaN(a)?0:a}
;function Kj(){this.i=!1;this.h=null}
Kj.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.i=!0,zj(b,function(){g.i=!1;var h=0<=b.indexOf("/th/");(h?window.trayride:window.botguard)?Lj(g,c,!!f,h,d):(Ej(b),qj(new W("Unable to load Botguard","from "+b)))},e)):a&&(e=Fc(document,"SCRIPT"),e.textContent=a,e.nonce=Ea(),document.head.appendChild(e),document.head.removeChild(e),((a=a.includes("trayride"))?window.trayride:window.botguard)?Lj(this,c,!!f,a,d):qj(Error("Unable to load Botguard from JS")))};
function Lj(a,b,c,d,e){var f,g;if(d=d?null===(f=window.trayride)||void 0===f?void 0:f.ad:null===(g=window.botguard)||void 0===g?void 0:g.bg)if(c)try{Mj(a,new d(b,e?function(){return e(b)}:Ia))}catch(h){h instanceof Error&&qj(h)}else{try{Mj(a,new d(b))}catch(h){h instanceof Error&&qj(h)}e&&e(b)}else qj(Error("Failed to finish initializing VM"))}
Kj.prototype.invoke=function(a){a=void 0===a?{}:a;return this.h?this.h.hasOwnProperty("hot")?this.h.hot(void 0,void 0,a):this.h.invoke(void 0,void 0,a):null};
Kj.prototype.dispose=function(){this.h=null};
function Mj(a,b){a.h=b}
;var Nj=new Kj;function Oj(){return!!Nj.h}
function Pj(a){a=void 0===a?{}:a;return Nj.invoke(a)}
;var Qj={Lb:29434,Nb:3611,Ce:3854,Uf:42993,Fi:4724,qj:96370,gb:27686,hb:85013,ib:23462,kb:42016,lb:62407,mb:26926,jb:43781,nb:51236,ob:79148,pb:50160,qb:77504,Cb:87907,Db:18630,Eb:54445,Fb:80935,Gb:105675,Hb:37521,Ib:47786,Jb:98349,Kb:6827,Mb:7282,Qb:32276,Pb:76278,Rb:93911,Sb:106531,Tb:27259,Ub:27262,Vb:27263,Xb:21759,Yb:27107,Zb:62936,ac:49568,cc:38408,dc:80637,ec:68727,fc:68728,hc:80353,ic:80356,jc:74610,kc:45707,lc:83962,mc:83970,nc:46713,oc:89711,pc:74612,qc:93265,sc:74611,uc:113533,wc:93252,
...
tk:82039};function Rj(a,b,c){O.call(this);var d=this;c=c||H("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.j=b||null;this.C="*";this.l=c;this.sessionId=null;this.channel="widget";this.F=!!a;this.A=function(e){a:if(!("*"!=d.l&&e.origin!=d.l||d.j&&e.source!=d.j||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.F&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(Rj,O);Rj.prototype.sendMessage=function(a,b){if(b=b||this.j){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.C)}catch(d){lf(d)}}};
Rj.prototype.B=function(){window.removeEventListener("message",this.A);O.prototype.B.call(this)};function Sj(){this.l=[];this.isReady=!1;this.o={};var a=this.i=new Rj(!!H("WIDGET_ID_ENFORCE")),b=this.Va.bind(this);a.m=b;a.u=null;this.i.channel="widget";if(a=H("WIDGET_ID"))this.i.sessionId=a}
m=Sj.prototype;m.Va=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.o[a]||"onReady"===a||(this.addEventListener(a,Tj(this,a)),this.o[a]=!0)):this.oa(a,b,c)};
m.oa=function(){};
function Tj(a,b){return function(c){return a.sendMessage(b,c)}}
...
m.dispose=function(){this.i=null};function Vj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
;function Zj(a){Sj.call(this);this.h=a;this.j=[];this.addEventListener("onReady",D(this.Sa,this));this.addEventListener("onVideoProgress",D(this.bb,this));this.addEventListener("onVolumeChange",D(this.cb,this));this.addEventListener("onApiChange",D(this.Wa,this));this.addEventListener("onPlaybackQualityChange",D(this.Ya,this));this.addEventListener("onPlaybackRateChange",D(this.Za,this));this.addEventListener("onStateChange",D(this.ab,this));this.addEventListener("onWebglSettingsChanged",D(this.eb,
this))}
v(Zj,Sj);m=Zj.prototype;m.oa=function(a,b,c){if(this.h.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Vj(a)){var d=b;if(B(d[0])&&!Array.isArray(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Xj.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Wj.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Yj.apply(window,d)}d=e}b.length=1;b[0]=d}this.h.handleExternalCall(a,b,c);Vj(a)&&Uj(this,this.ja())}};
...
m.Ya=function(a){Uj(this,{playbackQuality:a})};
m.Za=function(a){Uj(this,{playbackRate:a})};
...
m.cb=function(){Uj(this,{muted:this.h.isMuted(),volume:this.h.getVolume()})};
m.bb=function(a){a={currentTime:a,videoBytesLoaded:this.h.getVideoBytesLoaded(),videoLoadedFraction:this.h.getVideoLoadedFraction(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.h.getPlaybackRate(),mediaReferenceTime:this.h.getMediaReferenceTime()};this.h.getProgressState&&(a.progressState=this.h.getProgressState());Uj(this,a)};
m.eb=function(){var a={sphericalProperties:this.h.getSphericalProperties()};Uj(this,a)};
m.dispose=function(){Sj.prototype.dispose.call(this);for(var a=0;a<this.j.length;a++){var b=this.j[a];this.h.removeEventListener(b.eventType,b.listener)}this.j=[]};function ak(){var a=mb(bk),b;return De(new P(function(c,d){a.onSuccess=function(e){cg(e)?c(e):d(new ck("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new ck("Unknown request error","net.unknown",e))};
a.onTimeout=function(e){d(new ck("Request timed out","net.timeout",e))};
b=ig("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Ee&&b.abort();
return Be(c)})}
function ck(a,b,c){Ua.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
v(ck,Ua);function dk(){this.i=0;this.h=null}
dk.prototype.then=function(a,b,c){return 1===this.i&&a?(a=a.call(c,this.h),we(a)?a:ek(a)):2===this.i&&b?(a=b.call(c,this.h),we(a)?a:fk(a)):this};
dk.prototype.getValue=function(){return this.h};
dk.prototype.$goog_Thenable=!0;function fk(a){var b=new dk;a=void 0===a?null:a;b.i=2;b.h=void 0===a?null:a;return b}
function ek(a){var b=new dk;a=void 0===a?null:a;b.i=1;b.h=void 0===a?null:a;return b}
;function gk(a){Ua.call(this,a.message||a.description||a.name);this.isMissing=a instanceof hk;this.isTimeout=a instanceof ck&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Ee}
v(gk,Ua);gk.prototype.name="BiscottiError";function hk(){Ua.call(this,"Biscotti ID is missing from server")}
v(hk,Ua);hk.prototype.name="BiscottiMissingError";var bk={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},ik=null;
function Of(){if(S("disable_biscotti_fetch_on_html5_clients"))return Be(Error("Fetching biscotti ID is disabled."));if(S("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!Yc.get("CONSENT","").startsWith("YES+"))return Be(Error("User has not consented - not fetching biscotti id."));if("1"==kb())return Be(Error("Biscotti ID is not available in private embed mode"));ik||(ik=De(ak().then(jk),function(a){return kk(2,a)}));
return ik}
function jk(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new hk;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new hk;a=a.id;Pf(a);ik=ek(a);lk(18E5,2);return a}
function kk(a,b){b=new gk(b);Pf("");ik=fk(b);0<a&&lk(12E4,a-1);throw b;}
function lk(a,b){T(function(){De(ak().then(jk,function(c){return kk(b,c)}),Ia)},a)}
function mk(){try{var a=A("yt.ads.biscotti.getId_");return a?a():Of()}catch(b){return Be(b)}}
;function nk(a){if("1"!=kb()){a&&Nf();try{mk().then(function(){},function(){}),T(nk,18E5)}catch(b){kf(b)}}}
;var ok=Date.now().toString();
function pk(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=Date.now();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(ok)for(a=1,b=0;b<ok.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^ok.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var qk,rk=x.ytLoggingDocDocumentNonce_;rk||(rk=pk(),Sa("ytLoggingDocDocumentNonce_",rk));qk=rk;var sk={Pd:0,Ob:1,Wb:2,Ug:3,Rd:4,ak:5,Jh:6,Li:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function tk(a){this.h=a}
...
y("yt_logging_screen.getRootVeType",xk,void 0);function yk(a){return(a=xk(void 0===a?0:a))?new tk({veType:a,youtubeData:void 0}):null}
function zk(){var a=H("csn-to-ctt-auth-info");a||(a={},R("csn-to-ctt-auth-info",a));return a}
function Ak(a){a=void 0===a?0:a;var b=H(vk(a));if(!b&&!H("USE_CSN_FALLBACK",!0))return null;b||0!=a||(b="UNDEFINED_CSN");return b?b:null}
y("yt_logging_screen.getCurrentCsn",Ak,void 0);function Bk(a,b,c){var d=zk();(c=Ak(c))&&delete d[c];b&&(d[a]=b)}
function Ck(a){return zk()[a]}
y("yt_logging_screen.getCttAuthInfo",Ck,void 0);function Dk(a,b,c,d){c=void 0===c?0:c;if(a!==H(vk(c))||b!==H(wk(c)))Bk(a,d,c),R(vk(c),a),R(wk(c),b),b=function(){setTimeout(function(){a&&fh("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:qk,clientScreenNonce:a},Zi)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
y("yt_logging_screen.setCurrentScreen",Dk,void 0);function Ek(a){yh.call(this,1,arguments);this.csn=a}
v(Ek,yh);var Hh=new zh("screen-created",Ek),Fk=[],Hk=Gk,Ik=0;function Jk(a,b,c,d){c={csn:b,parentVe:c.getAsJson(),childVes:$a(d,function(f){return f.getAsJson()})};
d=u(d);for(var e=d.next();!e.done;e=d.next())e=e.value.getAsJson(),(ib(e)||!e.trackingParams&&!e.veType)&&qj(Error("Child VE logged with no data"));d={D:Ck(b),M:b};"UNDEFINED_CSN"==b?Kk("visualElementAttached",c,d):a?fh("visualElementAttached",c,a,d):$i("visualElementAttached",c,d)}
function Gk(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return xc(b)}
function Kk(a,b,c){Fk.push({payloadName:a,payload:b,options:c});Ik||(Ik=Ih())}
function Jh(a){if(Fk){for(var b=u(Fk),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,fh(c.payloadName,c.payload,null,c.options));Fk.length=0}Ik=0}
...
Ja(Lk);function Mk(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Nk(a)||c.some(function(e){return!Nk(e)}))throw Error("Only objects may be merged.");
...
function Qk(a,b){b=u(b);for(var c=b.next();!c.done;c=b.next())c=c.value,Nk(c)?a.push(Ok({},c)):Pk(c)?a.push(Qk([],c)):a.push(c);return a}
function Nk(a){return"object"===typeof a&&!Array.isArray(a)}
function Pk(a){return"object"===typeof a&&Array.isArray(a)}
;function Rk(a,b){yh.call(this,1,arguments)}
v(Rk,yh);function Sk(a,b){yh.call(this,1,arguments)}
v(Sk,yh);var Tk=new zh("aft-recorded",Rk),Uk=new zh("timing-sent",Sk);var Vk=window;function Wk(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var Xk=Vk.performance||Vk.mozPerformance||Vk.msPerformance||Vk.webkitPerformance||new Wk;var Yk=!1;D(Xk.clearResourceTimings||Xk.webkitClearResourceTimings||Xk.mozClearResourceTimings||Xk.msClearResourceTimings||Xk.oClearResourceTimings||Ia,Xk);function Zk(a){var b=$k(a);if(b.aft)return b.aft;a=H((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function al(a){var b;(b=A("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Sa("ytcsi."+(a||"")+"data_",b));return b}
function bl(a){a=al(a);a.info||(a.info={});return a.info}
function $k(a){a=al(a);a.tick||(a.tick={});return a.tick}
function cl(a){var b=al(a).nonce;b||(b=pk(),al(a).nonce=b);return b}
function dl(a){var b=$k(a||""),c=Zk(a);c&&!Yk&&(Eh(Tk,new Rk(Math.round(c-b._start),a)),Yk=!0)}
;function el(){var a=A("ytcsi.debug");a||(a=[],y("ytcsi.debug",a,void 0),y("ytcsi.reference",{},void 0));return a}
function fl(a){a=a||"";var b=A("ytcsi.reference");b||(el(),b=A("ytcsi.reference"));if(b[a])return b[a];var c=el(),d={timerName:a,info:{},tick:{},span:{}};c.push(d);return b[a]=d}
;var gl=x.ytLoggingLatencyUsageStats_||{};y("ytLoggingLatencyUsageStats_",gl,void 0);function hl(){this.h=0}
function il(){hl.h||(hl.h=new hl);return hl.h}
hl.prototype.tick=function(a,b,c){jl(this,"tick_"+a+"_"+b)||$i("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
hl.prototype.info=function(a,b){var c=Object.keys(a).join("");jl(this,"info_"+c+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,$i("latencyActionInfo",a))};
hl.prototype.span=function(a,b){var c=Object.keys(a).join("");jl(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,$i("latencyActionSpan",a))};
function jl(a,b){gl[b]=gl[b]||{count:0};var c=gl[b];c.count++;c.time=U();a.h||(a.h=Ef(function(){var d=U(),e;for(e in gl)gl[e]&&6E4<d-gl[e].time&&delete gl[e];a&&(a.h=0)},0,5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new W("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||qj(c)),!0):!1}
...
function pl(a){return!!H("FORCE_CSI_ON_GEL",!1)||S("csi_on_gel")||!!al(a).useGel}
...
;function rl(a,b,c){if(null!==b)if(bl(c)[a]=b,pl(c)){var d=b;b=ql(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in kl){b=kl[a];0<=Ya(ll,b)&&(d=!!d);a in nl&&"string"===typeof d&&(d=nl[a]+d.toUpperCase());a=d;d=b.split(".");for(var g=e={},h=0;h<d.length-1;h++){var k=d[h];g[k]={};g=g[k]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=Mk({},e)}else 0<=Ya(ol,a)||qj(new W("Unknown label logged with GEL CSI",
a)),f=void 0;f&&pl(c)&&(b=fl(c||""),Mk(b.info,f),b=ql(c),b.gelInfos||(b.gelInfos={}),Mk(b.gelInfos,f),c=cl(c),il().info(f,c))}else fl(c||"").info[a]=b}
function sl(a,b,c){var d=$k(c);if(!b&&"_"!==a[0]){var e=a;Xk.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),Xk.mark(e))}e=b||U();d[a]=e;e=ql(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||U();if(pl(c)){fl(c||"").tick[a]=b||U();e=cl(c);if("_start"===a){var f=il();jl(f,"baseline_"+e)||$i("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else il().tick(a,e,b);dl(c);e=!0}else e=!1;if(!e){if(!A("yt.timing."+(c||"")+"pingSent_")&&(f=H((c||"")+"TIMING_ACTION",void 0),e=
$k(c),A("ytglobal.timing"+(c||"")+"ready_")&&f&&"_start"in $k(void 0)&&Zk(c)))if(dl(c),c)tl(c);else{f=!0;var g=H("TIMING_WAIT",[]);if(g.length)for(var h=0,k=g.length;h<k;++h)if(!(g[h]in e)){f=!1;break}f&&tl(c)}fl(c||"").tick[a]=b||U()}return d[a]}
function tl(a){if(!pl(a)){var b=$k(a),c=bl(a),d=b._start,e=H("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:H((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=Zk(a);var h=$k(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&bl(a).yt_pvis&&"youtube"===e&&(rl("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var p in c)"_"!==p.charAt(0)&&(f[p]=c[p]);b.ps=U();p={};e=[];for(var n in b)"_"!==n.charAt(0)&&(k=Math.round(b[n]-d),p[n]=k,e.push(n+"."+k));f.rt=
e.join(",");b=!!c.ap;c="";for(var q in f)f.hasOwnProperty(q)&&(c+="&"+q+"="+f[q]);f="/csi_204?"+c.substring(1);window.navigator&&window.navigator.sendBeacon&&(b||S("always_send_csi_204_with_beacon"))?xg(f):ug(f);y("yt.timing."+(a||"")+"pingSent_",!0,void 0);Eh(Uk,new Sk(p.aft+(Number(g)||0),a))}}
var ul=window;ul.ytcsi&&(ul.ytcsi.info=rl,ul.ytcsi.tick=sl);function vl(){this.l=[];this.o=[];this.h=[];this.i=new Set;this.m=new Map}
function wl(a,b,c){c=void 0===c?0:c;b.then(function(d){var e,f;a.i.has(c)&&a.j&&a.j();var g=Ak(c),h=yk(c);g&&h&&(d.csn=g,(null===(e=d.response)||void 0===e?0:e.trackingParams)&&Jk(a.client,g,h,[uk(d.response.trackingParams)]),(null===(f=d.playerResponse)||void 0===f?0:f.trackingParams)&&Jk(a.client,g,h,[uk(d.playerResponse.trackingParams)]))})}
function xl(a,b,c,d){d=void 0===d?0:d;if(a.i.has(d))a.l.push([b,c]);else{var e=Ak(d);c=c||yk(d);e&&c&&Jk(a.client,e,c,[b])}}
vl.prototype.clickCommand=function(a,b,c){c=Ak(void 0===c?0:c);if(!a.clickTrackingParams||!c)return!1;var d=this.client;var e="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";a={csn:c,ve:uk(a.clickTrackingParams).getAsJson(),gestureType:e};b&&(a.clientData=b);b={D:Ck(c),M:c};"UNDEFINED_CSN"==c?Kk("visualElementGestured",a,b):d?fh("visualElementGestured",a,d,b):$i("visualElementGestured",a,b);return!0};
function yl(a,b,c){c=void 0===c?{}:c;a.i.add(c.layer||0);a.j=function(){zl(a,b,c);var f=yk(c.layer);if(f){for(var g=u(a.l),h=g.next();!h.done;h=g.next())h=h.value,xl(a,h[0],h[1]||f,c.layer);f=u(a.o);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=Ak(g);var l=k[0]||yk(g);h&&l&&(g=a.client,k=k[1],k={csn:h,ve:l.getAsJson(),clientData:k},l={D:Ck(h),M:h},"UNDEFINED_CSN"==h?Kk("visualElementStateChanged",k,l):g?fh("visualElementStateChanged",k,g,l):$i("visualElementStateChanged",
k,l))}}};
Ak(c.layer)||a.j();if(c.ta)for(var d=u(c.ta),e=d.next();!e.done;e=d.next())wl(a,e.value,c.layer);else rj(Error("Delayed screen needs a data promise."))}
function zl(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Ta?c.Ta:c.layer;var e=Ak(d);d=yk(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));try{var g=a.client,h=f,k=c.sa,l=c.D,p=Hk(),n={csn:p,pageVe:(new tk({veType:b,youtubeData:void 0})).getAsJson()};h&&h.visualElement?n.implicitGesture={parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()}:h&&qj(new W("newScreen() parent element does not have a VE - rootVe",
b));k&&(n.cloneCsn=k);k={D:l,M:p};g?fh("screenCreated",n,g,k):$i("screenCreated",n,k);Eh(Hh,new Ek(p));var q=p}catch(r){sj(r,{Dk:b,rootVe:d,parentVisualElement:void 0,yk:e,Ck:f,sa:c.sa});rj(r);return}Dk(q,b,c.layer,c.D);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=S("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(sk));for(f=b.next();!f.done;f=b.next())if(Ak(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,f=!0,g=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:g},f={D:Ck(e),M:e,
Fa:f},"UNDEFINED_CSN"==e?Kk("visualElementHidden",d,f):b?fh("visualElementHidden",d,b,f):$i("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=q||"");rl("csn",q);Lk.getInstance().clear();d=yk(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(S("web_mark_root_visible")||S("music_web_mark_root_visible"))&&(e=q,q=S("use_default_events_client")?void 0:Zi,b={csn:e,ve:d.getAsJson(),eventType:1},f={D:Ck(e),M:e},"UNDEFINED_CSN"==e?Kk("visualElementShown",b,f):q?fh("visualElementShown",
b,q,f):$i("visualElementShown",b,f));a.i.delete(c.layer||0);a.j=void 0;e=u(a.m);for(q=e.next();!q.done;q=e.next())q=u(q.value),b=q.next().value,q.next().value.has(c.layer)&&d&&xl(a,b,d,c.layer)}
;function Al(a){O.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.za,this)}
v(Al,O);m=Al.prototype;m.start=function(){this.started||this.h||(this.started=!0,this.connection.P("RECEIVING"))};
...
m.B=function(){var a=this.connection;a.h||Oe(a.i,"command",this.za,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);O.prototype.B.call(this)};function Dl(a,b){Al.call(this,b);this.api=a;this.start()}
...
function Bl(a,b){switch(a){case "loadVideoById":return a=Xj(b),[a];case "cueVideoById":return a=Xj(b),[a];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return a=Yj(b),[a];case "cuePlaylist":return a=Yj(b),[a];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
Dl.prototype.B=function(){Al.prototype.B.call(this);delete this.api};function El(a){a=void 0===a?!1:a;O.call(this);this.i=new Q(a);Ad(this,Ra(yd,this.i))}
E(El,O);El.prototype.subscribe=function(a,b,c){return this.h?0:this.i.subscribe(a,b,c)};
...
Fl.prototype.B=function(){this.destination=this.j=null;El.prototype.B.call(this)};function Gl(a,b,c){O.call(this);this.destination=a;this.origin=c;this.i=xf(window,"message",this.j.bind(this));this.connection=new Fl(this,a,b);Ad(this,Ra(yd,this.connection))}
v(Gl,O);Gl.prototype.P=function(a,b,c,d){this.h||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(qe(a),this.origin))};
Gl.prototype.j=function(a){var b;if(b=!this.h)if(b=a.origin===this.origin)a:{b=this.destination;do{b:{var c=a.source;do{if(c===b){c=!0;break b}if(c===c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.connection,c.h||c.l("command",b.command,b.data,a.origin))}};
Gl.prototype.B=function(){yf(this.i);this.destination=null;O.prototype.B.call(this)};function Hl(){O.call(this);this.i=[]}
v(Hl,O);Hl.prototype.B=function(){for(;this.i.length;){var a=this.i.pop();a.target.removeEventListener(a.name,a.Da)}O.prototype.B.call(this)};function Il(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||mb(b);this.assets=a.assets||{};this.attrs=a.attrs||mb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
...
function Ll(a){var b=Ml(a),c=document.getElementById(b),d=c&&vj(c,"loaded");d||c&&!d||(c=Nl(a,b,function(){vj(c,"loaded")||(tj(c),Fg(b),T(Ra(Gg,b),0))}))}
...
function Ml(a){var b=Fc(document,"A");Rb(b,new K(a,Eb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ub(a)}
;function Ol(a,b,c,d){O.call(this);var e=this;this.F=b;this.webPlayerContextConfig=d;this.fa=!1;this.api={};this.T=this.m=null;this.I=new Q;this.i={};this.K=this.Z=this.elementId=this.ga=this.config=null;this.J=!1;this.l=this.A=null;this.aa={};this.Ba=["onReady"];this.lastError=null;this.qa=NaN;this.C={};this.Ca=new Hl(this);this.S=0;this.j=this.u=a;Ad(this,Ra(yd,this.I));Pl(this);Ql(this);Ad(this,Ra(yd,this.Ca));c?this.S=T(function(){e.loadNewVideoConfig(c)},0):d&&(Rl(this),Sl(this))}
v(Ol,O);m=Ol.prototype;m.getId=function(){return this.F};
...
function Wl(a){var b=!0,c=Xl(a);c&&a.config&&(a=Yl(a),b=vj(c,"version")===a);return b&&!!A("yt.player.Application.create")}
function Sl(a){if(!a.h&&!a.J){var b=Wl(a);if(b&&"html5"===(Xl(a)?"html5":null))a.K="html5",a.isReady()||Zl(a);else if($l(a),a.K="html5",b&&a.l&&a.u)a.u.appendChild(a.l),Zl(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.A=function(){c=!0;var d=am(a,"player_bootstrap_method")?A("yt.player.Application.createAlternate")||A("yt.player.Application.create"):A("yt.player.Application.create");var e=a.config?Ul(a.config):void 0;d&&d(a.u,e,a.webPlayerContextConfig);Zl(a)};
a.J=!0;b?a.A():(zj(Yl(a),a.A),(b=bm(a))&&Kl(b),cm(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function Xl(a){var b=Bc(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function Zl(a){var b;if(!a.h){var c=Xl(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.J=!1,!am(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||dm(a)):a.qa=T(function(){Zl(a)},50)}}
...
m.addEventListener=function(a,b){var c=this,d=Vl(this,b);d&&(0<=Ya(this.Ba,a)||this.i[a]||(b=fm(this,a),this.m&&this.m(a,b)),this.I.subscribe(a,d),"onReady"===a&&this.isReady()&&T(function(){d(c.api)},0))};
m.removeEventListener=function(a,b){this.h||(b=Vl(this,b))&&Oe(this.I,a,b)};
function Vl(a,b){var c=b;if("string"===typeof b){if(a.aa[b])return a.aa[b];c=function(d){for(var e=[],f=0;f<arguments.length;++f)e[f-0]=arguments[f];(f=A(b))&&f.apply(x,e)};
a.aa[b]=c}return c?c:null}
function fm(a,b){var c="ytPlayer"+b+a.F;a.i[b]=c;x[c]=function(d){var e=T(function(){if(!a.h){a.I.O(b,d);var f=a.C,g=String(e);g in f&&delete f[g]}},0);
jb(a.C,String(e))};
return c}
...
m.cancel=function(){this.A&&Fj(Yl(this),this.A);Af(this.qa);this.J=!1};
m.B=function(){$l(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){kf(b)}this.aa=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(x[this.i[a]]=null);this.ga=this.config=this.api=null;delete this.u;delete this.j;O.prototype.B.call(this)};
...
;function om(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=H("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=H("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=Xb(window.location.href);g&&f.push(g);g=Xb(d);if(0<=Ya(f,g)||!g&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(f=document.createElement("a"),Rb(f,d),d=f.href),d){g=d.match(Vb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:Ak()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Ub(d).toString(36),e=e?Zb(e):"",hh(b,e,k||5))}else k=b,e="ST-"+Ub(d).toString(36),k=k?Zb(k):"",hh(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var p=void 0===p?"":p;var n=void 0===n?window:n;c=n.location;a=$b(a,l)+p;a=a instanceof K?a:Jb(a);c.href=Fb(a)}return!0}
;y("yt.setConfig",R,void 0);y("yt.config.set",R,void 0);y("yt.setMsg",nf,void 0);y("yt.msgs.set",nf,void 0);y("yt.logging.errors.log",rj,void 0);
y("writeEmbed",function(){var a=H("PLAYER_CONFIG",void 0);if(!a){var b=H("PLAYER_VARS",void 0);b&&(a={args:b})}nk(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=H("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);if((c=H("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;
if(!c.serializedForcedExperimentIds){var d=window.location.href;-1!=d.indexOf("?")?(d=(d||"").split("#")[0],d=d.split("?",2),d=Wf(1<d.length?d[1]:d[0])):d={};d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}km=im(a,c,!1)}else km=im(a);km.addEventListener("onVideoDataChange",nm);a=H("POST_MESSAGE_ID","player");H("ENABLE_JS_API")?mm=new Zj(km):H("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(lm=new Gl(window.parent,a,b),mm=new Dl(km,lm.connection));Ij()},
void 0);
...
d&-67108865;0==d?delete V[b]:(c=d.toString(16),V[b]=c.toString());c=!0;S("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.h;d=[];for(var f in V)d.push(f+"="+encodeURIComponent(String(V[f])));hh(b,d.join("&"),63072E3,a.i,c)}vl.h||(vl.h=new vl);a=vl.h;f=16623;var g=void 0===g?{}:g;Object.values(Qj).includes(f)||(qj(new W("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.h.push({rootVe:f,key:g.key||""});a.l=[];a.o=[];g.ta?yl(a,f,g):zl(a,f,g)}),qm=jf(function(){km&&
km.sendAbandonmentPing&&km.sendAbandonmentPing();
H("PL_ATT")&&Nj.dispose();for(var a=0,b=Gj.length;a<b;a++)Hf(Gj[a]);Gj.length=0;Ej("//static.doubleclick.net/instream/ad_status.js");Hj=!1;R("DCLKSTAT",0);zd(mm,lm);km&&(km.removeEventListener("onVideoDataChange",nm),km.destroy())});
window.addEventListener?(window.addEventListener("load",pm),window.addEventListener("unload",qm)):window.attachEvent&&(window.attachEvent("onload",pm),window.attachEvent("onunload",qm));Sa("yt.abuse.player.botguardInitialized",A("yt.abuse.player.botguardInitialized")||Oj);Sa("yt.abuse.player.invokeBotguard",A("yt.abuse.player.invokeBotguard")||Pj);Sa("yt.abuse.dclkstatus.checkDclkStatus",A("yt.abuse.dclkstatus.checkDclkStatus")||Jj);
Sa("yt.player.exports.navigate",A("yt.player.exports.navigate")||om);Sa("yt.util.activity.init",A("yt.util.activity.init")||Jf);Sa("yt.util.activity.getTimeSinceActive",A("yt.util.activity.getTimeSinceActive")||Mf);Sa("yt.util.activity.setTimestamp",A("yt.util.activity.setTimestamp")||Kf);}).call(this);
